...
namespace MVCCoreCRUDwithEFCore.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NhanVienId,HoTen,ViTri,NoiLamViec,MucLuong")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NhanVienId,HoTen,ViTri,NoiLamViec,MucLuong")] NhanVien nhanVien)
        {
